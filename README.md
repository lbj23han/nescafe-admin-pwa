...
### **v1.2 (2025-12)** — Floating Menu 도입

- 메인 페이지 우하단 고정 메뉴 버튼 추가
- 캘린더 영역 화면 확장
- 향후 기능 확장을 고려한 메뉴 구조 설계
